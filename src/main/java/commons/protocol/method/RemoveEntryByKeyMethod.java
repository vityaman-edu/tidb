...
public final class RemoveEntryByKeyMethod {
    private RemoveEntryByKeyMethod() {
    ...
    public static final class Result extends MethodResult {
        ...
        public ValidationResult validate() {
            return ValidationResult.of("result", this).verdict();
        }

        public String toString() {
            return "RemoveEntryByKeyMethod.Result()";
        }
    ...
    public static final class Invocation extends MethodInvocation<Result> {
        ...
        public ValidationResult validate() {
            return ValidationResult.of("RemoveEntryByKeyMethod", this).checking((v) -> {
                return v.key != null;
            }, "key is null").verdict();
        }
        ...
        public String toString() {
            return "RemoveEntryByKeyMethod.Invocation(key=" + this.key() + ")";
        }
